...
import ExampleTokens from '@/components/endpoints/ExampleTokens.vue'
...
<template>
    <section class="section">
        <Notifications v-if="!hasExtension" :notification="{
            message: 'Please instal Universal Profile browser extension.',
            type: 'warning',
        }" :hide-notification="true" class="mb-4"></Notifications>
